...
CREATE TABLE IF NOT EXISTS item_requests (
    ...
    CONSTRAINT fk_item_request_to_users FOREIGN KEY (requester_id) REFERENCES users (id)
);
...
CREATE TABLE IF NOT EXISTS items (
    ...
    CONSTRAINT fk_item_to_item_requests FOREIGN KEY (request_id) REFERENCES item_requests (id)
);
